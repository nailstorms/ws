...
public class RequestService {
    private static final String AUTH_STRING = new String(Base64.getEncoder().encode("test:test".getBytes()));
    ...
    public static List<Employee> findAllEmployees(Client client) throws SQLException, ParamException, AuthenticationException {
    ...
    public static Employee findEmployeeById(Client client, int id) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByName(Client client, String name) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesBySurname(Client client, String surname) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByGender(Client client, String gender) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByBirthday(Client client, String birthday) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesBySalary(Client client, int salary) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByFullName(Client client, String name, String surname) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByNameAndGender(Client client, String name, String gender) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByGenderAndBirthday(Client client, String gender, String birthday) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByGenderAndSalary(Client client, String gender, int salary) throws SQLException, ParamException, AuthenticationException {
    ...
    public static List<Employee> findEmployeesByFullInfo(
            ...
            String surname,
            String gender,
            String birthday) throws SQLException, ParamException, AuthenticationException {
    ...
    public static int createEmployee(Client client,
                                     ...
                                     String gender,
                                     String birthday,
                                     int salary) throws SQLException, ParamException, AuthenticationException {
    ...
    public static Boolean deleteEmployee(Client client, int id) throws SQLException, ParamException, AuthenticationException {
    ...
    private static ClientResponse executeGet(WebResource webResource, String excStr) throws ParamException, SQLException, AuthenticationException {
    ...
    private static ClientResponse executePost(WebResource webResource, String contentType, String excStr) throws SQLException, ParamException, AuthenticationException {
        ClientResponse response = webResource
                .accept(contentType)
    ...
    private static ClientResponse executeDelete(WebResource webResource, String excStr) throws SQLException, ParamException, AuthenticationException {
        ClientResponse response = webResource
                .accept(MediaType.APPLICATION_JSON)
                .header("Authorization", "Basic " + AUTH_STRING)
    ...
    private static void checkExceptions(ClientResponse response, String excStr) throws ParamException, SQLException, AuthenticationException {

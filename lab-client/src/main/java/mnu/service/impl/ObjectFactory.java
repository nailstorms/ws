...
public class ObjectFactory {
    ...
    private final static QName _UnauthorizedUserException_QNAME = new QName("http://impl.service.mnu/", "UnauthorizedUserException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.mnu/", name = "UnauthorizedUserException")
    public JAXBElement<EmployeeServiceFault> createUnauthorizedUserException(EmployeeServiceFault value) {
        return new JAXBElement<EmployeeServiceFault>(_UnauthorizedUserException_QNAME, EmployeeServiceFault.class, null, value);
    }

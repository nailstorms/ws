...
public interface EmployeeWebServiceImpl {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getEmbedImage", targetNamespace = "http://impl.service.mnu/", className = "mnu.service.impl.GetEmbedImage")
    @ResponseWrapper(localName = "getEmbedImageResponse", targetNamespace = "http://impl.service.mnu/", className = "mnu.service.impl.GetEmbedImageResponse")
    public byte[] getEmbedImage();

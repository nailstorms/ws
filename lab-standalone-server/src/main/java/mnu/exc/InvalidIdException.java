...
public class InvalidIdException extends Exception {
    ...
    public InvalidIdException(String message, EmployeeServiceFault fault) {
        super(message);
        this.fault = fault;
    }

    public InvalidIdException(String message, EmployeeServiceFault fault, Throwable cause) {
        super(message, cause);
        this.fault = fault;
    }
